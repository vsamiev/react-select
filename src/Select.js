...
const Select = React.createClass({
	...
	propTypes: {
		...
		keepOpen: React.PropTypes.bool,       			// keep menu open after select
	},
	statics: { Async },
	...
	filterOptions (excludeOptions) {
		...
		if (options.length == 0 && this.props.allowCreate){
			let createNewOption = this.newOptionObject(this.state.inputValue);
			options = [createNewOption, ...options];
		}
		return options;
	},

	newOptionObject(filterValue){
		let option = this.props.createNewOption;
